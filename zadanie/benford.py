...
def detect_benford(filename):
	...
	benford_detected = [col_sum > 10 and col[1] / col_sum > 0.25 and col[1] / col_sum < 0.35 for (col, col_sum) in zip(register, records_count)]
...
print(detect_benford("census_2009b"))